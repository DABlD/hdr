...
<table style="width: 100%;">
	...
	<tr>
		{{-- <td colspan="2">Doctor's name: {{ isset($data->doctor) ? $data->doctor->fname . ' ' . $data->doctor->mname . ' ' . $data->doctor->lname . ', MD, ' . (isset($data->doctor->doctor->title) ? $data->doctor->doctor->title : "") : "-" }}</td> --}}
		<td colspan="2"></td>
